...
def get_timer0():
    ...
    if TIMER0_WGM["normal"] == spn_TIMER0_WGM.text:
        timer0_coma_convert(get_value(TIMER0_COM_NORMAL, spn_TIMER0_COM_A.text))
        timer0_comb_convert(get_value(TIMER0_COM_NORMAL, spn_TIMER0_COM_B.text))
        timer0_wgm_convert(get_value(TIMER0_WGM_NORMAL, spn_TIMER0_WGM_OPT.text))
    elif TIMER0_WGM["pwm"] == spn_TIMER0_WGM.text:
        timer0_coma_convert(get_value(TIMER0_COM_PWM, spn_TIMER0_COM_A.text))
        timer0_comb_convert(get_value(TIMER0_COM_PWM, spn_TIMER0_COM_B.text))
        timer0_wgm_convert(get_value(TIMER0_WGM_PWM, spn_TIMER0_WGM_OPT.text))
    elif TIMER0_WGM["fastpwm"] == spn_TIMER0_WGM.text:
        timer0_coma_convert(get_value(TIMER0_COM_FASTPWM, spn_TIMER0_COM_A.text))
        timer0_comb_convert(get_value(TIMER0_COM_FASTPWM, spn_TIMER0_COM_B.text))
